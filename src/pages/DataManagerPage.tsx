  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button onClick={() => setShowModal(activeTab === 'departments' ? 'add-dept' : 'add-room')} className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700"><Plus className="h-4 w-4 mr-2" /> Add {activeTab === 'departments' ? 'Department' : 'Room'}</button>
      </div>
